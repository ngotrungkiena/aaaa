( () => {
    ...
    var e = {
        ...
        48885: (e, t) => {
            ...
            t._$debounce = t._$DEFAULT_DEBOUNCE_TIME = void 0,
            t._$DEFAULT_DEBOUNCE_TIME = 150;
            t._$debounce = (e, _=t._$DEFAULT_DEBOUNCE_TIME) => {
                let E = 0;
                return (...t) => {
                    clearTimeout(E),
                    E = setTimeout( () => e(...t), _)
    ...
    function _(E) {
        ...
        return e[E].call(s.exports, s, s.exports, _),
        s.exports
    }
    ( () => {
        const e = _(35263)
        ...
        ( () => {
            ...
            function E() {
                window.postMessage({
                    _custom_type_: e._$MessageScriptType._$CUSTOM_ON_URL_CHANGED
                })
            }
        ...
        ( () => {
            ...
            try {
                if (globalThis.Shopify)
                    return void _(globalThis.Shopify);
